...
Data analysis is the process of inspecting, cleaning, transforming, modeling and visualizing and analysising data to discover useful information, draw conclusions that support decision making.
## Data Structure
